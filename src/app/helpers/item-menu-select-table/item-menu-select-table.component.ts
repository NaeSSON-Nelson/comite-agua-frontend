...
@Component({
  selector: 'app-item-menu-select-table',
  templateUrl: './item-menu-select-table.component.html',
  styles: [],
})
export class ItemMenuSelectTableComponent {
  data: ItemMenu[] = [];
  dataSelected: ItemMenu[] = [];
  titleTable:string='Tabla de asignacion de Items';
  ...
  ngOnInit(): void {
    ...
    this.itemsSub=this.helperService.itemsMenus.subscribe((res) => {
