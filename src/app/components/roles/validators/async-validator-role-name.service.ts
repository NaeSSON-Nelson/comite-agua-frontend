...
export class AsyncValidatorRoleNameService {

  API_URL = environment.apiURrl + '/roles';
  ...
  validarNombre(campo: string, campoId: string) {
    return (
      ...
      return this.http
        .get<HttpResponseApi<Role>>(`${this.API_URL}/name/${campoR}`, {
