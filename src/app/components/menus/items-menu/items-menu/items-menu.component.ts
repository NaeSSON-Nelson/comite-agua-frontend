...
import { PATH_AUTH, PATH_FORBBIDEN, PATH_ITEMSMENU, PATH_MODULE_DETAILS, PATH_REGISTRAR } from 'src/app/interfaces/routes-app';
...
export class ItemsMenuComponent {
  ...
  registrarNew(){
    ...
    this.router.navigate([PATH_ITEMSMENU, PATH_REGISTRAR],);
  }
}
